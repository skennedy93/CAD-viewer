...
function firstcad() {
    var linkone = ['public/CAD/Trunnion cdv/MartinTrunnion-CDV-XR.5/MartinTrunnion-CDV-XR.5.html']
...
<div><img class="ame-image-1" src={window.location.origin + '/images/BOTR.png'}/></div>
  ...
  <div><img class="amrok" src={window.location.origin + '/images/AMROKWhiteRGB.svg'}/></div>
</div>
  ...
  <iframe id="myIframe" src="https://www.ame.com/assets/Trunnion cdv/MartinTrunnion-CDV-XR.5/MartinTrunnion-CDV-XR.5.html" width="520" height="520" frameBorder="0" ></iframe>
  </div>
  </div>
