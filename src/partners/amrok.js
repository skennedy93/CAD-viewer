...
<div class="navbar">
  ...
  <div><img class="ame-image-2" src={window.location.origin + '/images/amrok-logo.png'}/></div>
</div>
  <div class="view-container">
  <div class="cad-buttons">
    <div class="row">
    <button type="button" class="button-basic" onClick={firstcad}><img src={window.location.origin + '/images/button-1.jpg'}/></button>
    <button type="button" class="button-basic" onClick={secondcad}><img src={window.location.origin + '/images/button-2.jpg'}/></button>
    </div>
   <div class="row">
  <button type="button" class="button-basic" onClick={firstcad}><img src={window.location.origin + '/images/button-1.jpg'}/></button>
  <button type="button" class="button-basic" onClick={secondcad}><img src={window.location.origin + '/images/button-2.jpg'}/></button>   
