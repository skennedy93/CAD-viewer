...
function firstcad() {
    var linkone = ['https://www.ame.com/assets/Mitee/AMROKTombstone-MiteeBite-XR.3/AMROKTombstone-MiteeBite-XR.3.html']
  ...
  function secondcad() {
    var linktwo = ['/CAD/Subplate - Mitee Bite/Subplate - Mitee-Bite - Sample 1.21/Subplate - Mitee-Bite - Sample 1.21.html']
  ...
  function thirdcad() {
    var linkthree = ['/CAD/Martin Trunnion - Mitee Bite/Martin Trunnion - Mitee-Bite - Sample 1.25/Martin Trunnion - Mitee-Bite - Sample 1.25.html']
...
<div><img class="ame-image-1" src={window.location.origin + '/images/BOTR.png'}/></div>
  ...
  <div><img class="amrok" src={window.location.origin + '/images/mitee-Bite-white.png'}/></div>
</div>
  ...
  <iframe id="myIframe" src="https://www.ame.com/assets/Mitee/AMROKTombstone-MiteeBite-XR.3/AMROKTombstone-MiteeBite-XR.3.html" width="520" height="520" frameBorder="0" ></iframe>
  </div>
  </div>
