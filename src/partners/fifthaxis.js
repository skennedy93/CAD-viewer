...
function firstcad() {
    var linkone = ['/CAD/Martin Trunnion - 5th Axis/Cone Seal.22/Cone Seal.22.html']
...
<div class="navbar">
  ...
  <div><img class="fifth-axis" src={window.location.origin + '/images/fifth-axis-white.svg'}/></div>
</div>
  ...
  <iframe id="myIframe" src="https://www.ame.com/assets/5thAxisXR/AMROKTombstone-5thAxis-XR.2/AMROKTombstone-5thAxis-XR.2.html" width="520" height="520" frameBorder="0" ></iframe>
  </div>
  </div>
